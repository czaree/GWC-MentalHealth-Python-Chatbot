...
if __name__ == "__main__":
  ...
  wait_animation()
  name = input("before we get started, tell me, what's your name?\n")
  ...
  emotions = ["sad", "angry", "happy", "anxious", "depressed", "mad"]
  ...
  happy_advice = ["glad you're feeling good! make sure to get plenty of rest to keep the ball rolling.", "that's great! keep up the good work!", "i'm proud of you!! i hope the rest of your week is just as great!"]
  wait_animation()
  print(greet[random.randrange(0, 3, 1)])
  wait_animation()
  #advice 1 output - asks how the user is feeling and prints the randomized response
  while True:
  ...
  goodbyes = [time_bye, "thanks for chatting with me! I'll catch you later", "i had a great time chatting today, hope to see you again sometime soon!"]
